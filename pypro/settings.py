...
# Para upload dos arquivos no site
...
if AWS_ACCESS_KEY_ID:
    ...
    AWS_QUERYSTRING_AUTH = True # para que possamos gerar url assinadas
    AWS_S3_CUSTOM_DOMAIN = None # vamos utilizar o mesmo dominio do S3
    AWS_DEFAULT_ACL = 'private' # para que os arquivos nao fiquem publicos
